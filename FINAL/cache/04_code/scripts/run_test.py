...
CUTOFF = pd.Timestamp("2024-08-31")   # 训练截断点(模拟"现在是 2024.08")
N_MONTHS = 22                          # 预测 2024.09–2026.06
N_ROUNDS = 30
USE_HOLT_MAIN = True   # 主预测方法 = Holt 趋势外推(实证:对持续趋势小区远优于集成,
                       # 北控偏差 27.7%→0.9%、帝泊湾 7.0%→-2.6%);False 则用集成递归预测
USE_CALIBRATION = True   # 偏差校准开关:True=用训练期验证偏差修正预测输出。
